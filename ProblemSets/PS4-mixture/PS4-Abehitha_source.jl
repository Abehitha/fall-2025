...
function variance_quadrature()
    ...
    println("more grid points mean better approximation")
end
...
function allwrap()
    ...
    println("Same interpretation as PS3; this time
    it's large and positive with t-stat>10")

    # Question 3: Practice with quadrature and Monte Carlo
    practice_quadrature()
    variance_quadrature() 
    practice_monte_carlo()
    println("accuracy improves with more draws")
